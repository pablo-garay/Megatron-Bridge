...
def _qwen3_moe_common(
    ...
    pipeline_parallelism_dtype: torch.dtype = torch.bfloat16,
    virtual_pipeline_parallelism: int | None = None,
    context_parallelism: int = 1,
    expert_parallelism: int | None = 4,
    ...
    Args:
        ...
        pipeline_parallelism_dtype (torch.dtype): Data type for pipeline parallelism.
        ...
        expert_parallelism (int | None): Degree of expert parallelism for MoE.
